...
if (isset($_POST['submit'])) {
    ...
    if ($db->update('data_barang', $update_data, "id_barang = '{$id}'")) {
        echo "<script>alert('Berhasil diubah!'); window.location='/Projek4/indek';</script>";
        exit();
    }
}
?>
    ...
    <div class="main-content">
        <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="submit">
                ...
                <a href="/Projek4/indek" style="margin-left:10px; text-decoration:none; color:gray;">Batal</a>
            </div>
        </form>
    </div>
</div>